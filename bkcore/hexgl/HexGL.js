...
bkcore.hexgl.HexGL.prototype.displayScore = function(f, l)
{
	...
	sf != undefined && (sf.href='http://www.facebook.com/sharer.php?s=100'
		...
		+'&p[summary]='+encodeURIComponent('HexGL is a futuristic HTML5 / WebGL racing game.')
		+'&p[url]='+encodeURIComponent('https://hexgl.blockchanger.io')
		+'&p[images][0]='+encodeURIComponent('https://hexgl.blockchanger.io/favicon.png'));
